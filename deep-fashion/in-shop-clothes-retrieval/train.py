...
# python train.py --bottleneck_dir=data/bottlenecks --how_many_training_steps 5000 --model_dir=data/inception --output_graph=models/retrained_graph.pb --output_labels=models/retrained_labels.txt --image_dir=/srv/downloads/moshfiqur-ml-datasets/deep-fashion/in-shop-clothes-retrieval/cropped_img/MEN
